...
def fetch_membranes(zStart, zStop, padX, padY, padZ):
  # membranes
  return oo.get_cutout('cv_kasthuri11_membrane_2014', 'image', 4400 - padX, 5424 + padX, 5440 - padY, 6464 + padY, 1100 - padZ, 1200 + padZ, resolution = 1);

def fetch_vesicles(zStart, zStop, padX, padY, padZ):
  # vesicles
  return oo.get_cutout('cv_kasthuri11_membrane_2014', 'annotation', resolution = 1)
